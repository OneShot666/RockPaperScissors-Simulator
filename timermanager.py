...
class TimerManager:                                                             # To manage all timers in program
    ...
    def set_duration(self, new_duration):                                       # Change duration of loop (can't exceed limits)
    ...
    def start(self, current_time):                                              # (re)start timer
    ...
    def pause(self, current_time):                                              # Pause timer
        if not self.is_paused_flag:
            self.is_paused_flag = True
            self.pause_time = current_time

    def unpause(self, current_time):                                            # Unpause timer
